 ...
 * @generated
 */
public class CertificationSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CertificationPackage.PROCESS: {
				certification.Process process = (certification.Process)theEObject;
	 ...
	 * @generated
	 */
	public T caseProcess(certification.Process object) {
		return null;
	}
